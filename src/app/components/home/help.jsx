            ...
            <div className='relative bg-white w-[100%] h-[170dvh] pb-16 flex items-center justify-center'>
                <div className="flex justify-center">
                    <div className="shadow-2xl flex h-auto">
                        ...
                        <div className="w-[35dvw] text-black flex flex-col justify-center items-center">
                            <h1 className="w-full p-6 flex justify-center font-bold text-3xl">
                                Connect with us
                            </h1>
                            <div className="w-full p-6 flex -mt-10 justify-center font-bold text-2xl">
                                <div className="bg-teal-400 w-[15dvw] h-[1dvh] rounded"></div>
                            </div>
                            <form onSubmit={donation}>
                                <div className="flex flex-col justify-center gap-2">
                                    ...
                                    <select
                                        className="border-2 px-10 py-2 text-center bg-slate-100"
                                        id="blood_group"
                                        value={blood_group}
